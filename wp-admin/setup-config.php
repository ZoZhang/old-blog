...
if ( version_compare( $required_php_version, phpversion(), '>' ) )
	wp_die( sprintf( /*WP_I18N_OLD_PHP*/'您所在服务器的 PHP 版本为 %1$s，低于 WordPress 的最低需求 %2$s，请联系主机提供商升级服务器的 PHP 版本后重新安装。'/*/WP_I18N_OLD_PHP*/, phpversion(), $required_php_version ) );

if ( !extension_loaded('mysql') && !file_exists(ABSPATH . 'wp-content/db.php') )
	wp_die( /*WP_I18N_OLD_MYSQL*/'您所在服务器的 PHP 没有安装 MySQL 组件，请联系主机提供商安装后重新安装。'/*/WP_I18N_OLD_MYSQL*/ );
...
<ol>
	...
	<li>数据库密码</li>
	<li>数据库主机</li>
	<li>数据表前缀（如果您想在同一个数据库里运行多个 WordPress）</li></ol>
